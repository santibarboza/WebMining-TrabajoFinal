...
RESULT_CLUSTERING = "ScriptsAuxiliares/ResultadosWeka/resultados-EM5.arff"
...
writer.write("Clustering: Expectation Maximization (5 clusters) - ResultadosWeka/resultados-EM-5.arff\n")
writer.write("-------------------------------------------------------------------------------------------------\n")
